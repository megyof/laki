...
#define MY_MQTT_PUBLISH_TOPIC_PREFIX "laki-mysensorsgw-out"
#define MY_MQTT_SUBSCRIBE_TOPIC_PREFIX "laki-mysensorsgw-in"

// Set MQTT client id
#define MY_MQTT_CLIENT_ID "laki-mysensorsgw-1"
